...
**Questions and comments** during lectures are mostly welcome! So just go ahead and fire. Specially if these are clarifications or alternative perspectives that may help the rest of the class.

Course evaluation
-----------------

Evaluation is done by means of **four group projects**, to be done in groups of 3 (preferable) or 2 students, plus a presentation of one randomly-selected report. The final grade (in the scale 0-10) is:
...
2.  Linear models III (weight: 20%; **deadline: 2018/01/04**).
3.  Generalized linear models (weight: 20%; **deadline: 2018/01/25**).
4.  Nonparametric regression (weight: 20%; **deadline: 2018/01/25**).

Weights and deadlines are subjected to minor changes due to the course development.
...
-   Length: **8 pages at most**. This includes tables, graphics, code, equations, appendices, etc. Everything must fit in 8 pages. Want extra space? You can buy it at `-1.00` points per extra page! ;)
...
-   Each group must present one report. Strict presentation policy: **all students must present for 5 minutes**. This is a 15-minutes or 10-minutes limit for the whole presentation, depending on the group size. Tailor your presentation to that duration and break it evenly among the group members.
